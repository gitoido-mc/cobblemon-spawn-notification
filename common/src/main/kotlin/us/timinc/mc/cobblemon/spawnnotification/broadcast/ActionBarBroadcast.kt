...
class ActionBarBroadcast(
...
) : PlayerSpecificBroadcast<ActionBarBroadcast.Params, ActionBarBroadcast.ChildParams>() {
    companion object {
    ...
    override fun getType(): BroadcastType<*, *, *> = SpawnNotification.BroadcastTypes.ACTION_BAR_BROADCAST
