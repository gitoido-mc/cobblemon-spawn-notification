...
object Chat : PlayerSpecificDestination<Chat.BroadcastData>() {
    class BroadcastData(
    ...
    override val codec: Codec<BroadcastData> = RecordCodecBuilder.create { instance ->
        instance.group(
            ...
            Codec.BOOL.fieldOf("broadcastAcrossDimensions").orElse(SpawnNotification.config.broadcastAcrossDimensions)
